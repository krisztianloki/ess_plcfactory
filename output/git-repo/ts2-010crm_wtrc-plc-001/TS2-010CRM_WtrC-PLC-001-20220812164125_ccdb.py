...
# External links for ICS_DigitalInput
factory.addLink("ICS_DigitalInput", "EPI[ICS_DigitalInput]", "https://gitlab.esss.lu.se/icshwi/ics_library_definitions")
...
#
# Adding device TS2-010CRM:WtrC-Virt-100 of type ICS_DigitalInput
#
dev = plc.addDevice("ICS_DigitalInput", "TS2-010CRM:WtrC-Virt-100")
