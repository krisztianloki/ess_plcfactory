...
def WriteDiagnostics(TIAVersion):
	...
	ExternalSourceFile.append("      ioSystem " + ExternalRead + " : Array[1.."+str(MAX_IO_SYSTEM)+"] of \"typeIoSystem\";   // diagnosis information IO systems");
	ExternalSourceFile.append("   END_VAR");
	ExternalSourceFile.append("");
	ExternalSourceFile.append("");
	ExternalSourceFile.append("BEGIN");
	...
	ExternalSourceFile.append("   VAR_IN_OUT ");
	ExternalSourceFile.append("      plc " + ExternalRead + " : \"typePlc\";   // The diagnostics structure for one PLC");
	ExternalSourceFile.append("      ioSystem " + ExternalRead + " : Array[1.."+str(MAX_IO_SYSTEM)+"] of \"typeIoSystem\";   // The diagnostics structure for one IO System");
	ExternalSourceFile.append("   END_VAR");
	ExternalSourceFile.append("");
	ExternalSourceFile.append("   VAR ");
...
def ProcessIFADevTypes(OutputDir, TIAVersion, CommsTest):
	...
	for device in ifa.Devices:
		...
		if Direct:
			...
			DeviceInstance.append("      StatusReg " + NoExternal + " : Array[0.."+ str(MaxStatusReg) +"] of Word;")
			DeviceInstance.append("      CommandReg " + NoExternal + " : Array[0.."+ str(MaxCommandReg) +"] of Word;")
